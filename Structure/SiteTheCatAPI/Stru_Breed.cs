...
{
    // breeds myDeserializedClass = JsonConvert.DeserializeObject<List<breeds>>(myJsonResponse);
    /// <summary>
    ///  Estrutura para acomodar dados recebidos do processo da chamada API do TheCatAPI
    ///  Url de Chamada no processo 
    ///  https://api.thecatapi.com/v1/breeds
    ///  Processo mapedo para versao de janeiro de 2023
    ///  Mapeamento realizado de acordo como a estrutura de retorno do JSON da API
    /// </summary>
    public class Stru_Breed
    {
